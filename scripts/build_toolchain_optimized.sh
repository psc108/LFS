...
echo "=== LFS Cross-Compilation Toolchain Build (Optimized) ==="
...
echo "Building Binutils (Optimized)..."
...
# Optimized configure with faster options
echo "Configuring Binutils with optimized settings..."
...
# Use fewer parallel jobs to avoid overwhelming the system
make -j2
